...
export default function AdaptReader() {
  ...
  if (error) return <section className="adapt-state"><span>这一章暂时没有准备好</span><h1>{title}</h1><p>{error.replace(/[。.]$/, '')}。知己已经自动查询维基文库和 Project Gutenberg；如果仍没有找到可核验的公版正文，我们不会凭模型记忆编写。</p><div><a href="/discover">换一本书</a><a className="secondary" href="/pdf">也可以导入我拥有的 PDF</a>{source && <a className="secondary" href={source} target="_blank" rel="noreferrer">查看来源记录 <ExternalLink size={14} /></a>}</div></section>;
